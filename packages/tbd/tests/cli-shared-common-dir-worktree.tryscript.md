...
• tbd_format f03 → f08: .tbd/config.yml updated in this checkout. Commit on this branch or merge main to publish the format upgrade.
...
# Test: Top-level config was migrated to f08 with common-dir storage
...
# Test: Common-dir layout uses the same f08 format ID
...
# Test: An f03-era client would reject the migrated f08 repository
...
Config format 'f08' is from a newer tbd version.

...
describe('tbd-format', () => {
  ...
  describe('generated integration format (split from the repository format)', () => {
    ...
    it('stamps both surfaces where this parser reads them', () => {
      // Only that the parser finds the stamp on each generated marker line; this
      // PR rewrote it to require a marker line, so the shapes are worth pinning.
      // Whether a real older release refuses these surfaces is proved by running
      // one: scripts/validate-upgrade-package.mjs.

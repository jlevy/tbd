 ...
 * Multi-line comment format matches flowmark's preferred output
 */
const GENERATED_FILE_MARKER = `<!-- DO NOT EDIT: Generated by tbd setup.
...
class SetupClaudeHandler extends BaseCommand {
  ...
  private async installClaudeSetup(settingsPath: string, skillPath: string): Promise<void> {
    ...
    try {
      ...
      skillContent = insertAfterFrontmatter(skillContent, GENERATED_FILE_MARKER);

...
updated_at: 2026-09-16T16:42:42.534Z
...
Updated merge-upstream and address-pr-review to query formal GitHub stack membership through repos/$REPO/stacks?pull_request=$PR_NUMBER before any merge-upstream path. Remote-only formal stacks must be adopted with gh stack checkout "$PR_URL" before sync/rebase; API, extension, or adoption failures stop the workflow. Pinned Markdown formatting and diff checks pass. Focused static coverage remains for the parent task.

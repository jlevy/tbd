...
WebHandler and command registration implemented with lazy server import, validated --port/--interval, --open, --dry-run, JSON descriptor, OutputManager output, and built help. Final close awaits stitched artifact plus spawned-process SIGINT/security/lifecycle tests.

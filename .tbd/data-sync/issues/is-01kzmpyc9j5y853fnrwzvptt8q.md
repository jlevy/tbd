...
Expanded the real-Git release smoke with two concurrent watchers in one checkout; bead, multi-bead, label, status, spec, ready, and all selectors; human/JSON/quiet modes; exit classes 0/1/2/3; active-watch show/list/ready/full-pull/status coexistence; and protected caller/ref/FETCH_HEAD/hidden-worktree/lock/private-ref baselines. Added the built-candidate smoke to Ubuntu, macOS, and Windows CI. Source and isolated-prefix packed-candidate smokes passed; precommit/pre-push passed 100 files and 1,451 tests; all 1,068 Tryscript cases passed; publint passed; package-age found 0 violations across 31 pins. Exact-head run 31351016944 passed every job, including all three operating-system smokes.

...
updated_at: 2026-09-10T08:09:27.729Z
...
duplicate_of: null
---
PR #283 landing review found docs/project/specs/active/plan-2026-09-06-bead-coordination-and-native-comments.md assigned packages/tbd/src/native-comments/bounded-file.ts to the PR #282 component row even though PR #283 extracted and added it. Move that module to the PR #283 row so the executable plan matches commit ownership.

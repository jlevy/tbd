...
updated_at: 2026-08-10T02:41:44.411Z
---
...
Automated source and isolated-prefix tarball smokes now pass with concurrent watchers, every selector, output mode, exit class, coexistence checks, and protected-state assertions; cross-platform built-candidate smoke is wired into CI. Remaining release-promotion evidence: repeat the tarball at the exact release-tag SHA and checksum; run the exact artifact under Node 20; credentialed private GitHub remote; before/after protected-state snapshot; brief/persistent transport failures; durable worker restart/idempotency; intended runner permissions; representative macOS/Linux/Windows packed-artifact and shell samples; human operator review; idle soak. Linear remains non-gating.

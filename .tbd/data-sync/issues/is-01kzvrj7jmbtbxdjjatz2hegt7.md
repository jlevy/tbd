...
updated_at: 2026-08-12T23:58:49.897Z
...
PR #209 review disposition: the only inline comment questioned whether ---yml routes through the custom engine. Verified gray-matter aliases yml to yaml before engine lookup; the wrapper test matrix exercises yml. Replied with evidence and resolved the false-positive thread.

...
- @docs/tbd-design.md — Complete design specification
...
`tbd-design.md`. The implementation includes:
...
| tbd-2001 | Update design spec (tbd-design.md) | Done | All path references updated |
...
**Design Changes (already updated in tbd-design.md):**
...
**Design Reference:** See tbd-design.md §6.4 for full specification, including:
